...
('Lisinopril', 'lisinopril', 'ACE Inhibitor', '["lisinopril"]', '{"pregnancy", "angioedema"}', '{"cough", "hyperkalemia", "hypotension"}'),
('Metformin', 'metformin hydrochloride', 'Antidiabetic', '["metformin"]', '{"kidney disease", "metabolic acidosis"}', '{"nausea", "diarrhea", "lactic acidosis"}'),
('Atorvastatin', 'atorvastatin calcium', 'Statin', '["atorvastatin"]', '{"liver disease", "pregnancy"}', '{"myalgia", "elevated liver enzymes"}'),
('Amlodipine', 'amlodipine besylate', 'Calcium Channel Blocker', '["amlodipine"]', '{"severe hypotension"}', '{"edema", "dizziness", "flushing"}'),
('Omeprazole', 'omeprazole', 'Proton Pump Inhibitor', '["omeprazole"]', '{"hypersensitivity"}', '{"headache", "nausea", "diarrhea"}'),
('Warfarin', 'warfarin sodium', 'Anticoagulant', '["warfarin"]', '{"bleeding disorders", "pregnancy"}', '{"bleeding", "bruising"}'),
('Aspirin', 'acetylsalicylic acid', 'NSAID', '["aspirin"]', '{"bleeding disorders", "children with viral infections"}', '{"GI bleeding", "tinnitus"}'),
('Ibuprofen', 'ibuprofen', 'NSAID', '["ibuprofen"]', '{"kidney disease", "heart failure"}', '{"GI upset", "kidney problems"}'),
('Simvastatin', 'simvastatin', 'Statin', '["simvastatin"]', '{"liver disease", "pregnancy"}', '{"myopathy", "liver problems"}'),
('Digoxin', 'digoxin', 'Cardiac Glycoside', '["digoxin"]', '{"ventricular fibrillation"}', '{"nausea", "arrhythmias"}');
